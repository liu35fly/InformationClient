package com.hm.zhihuclient.frag_hot.view;
...
public class HotLayout extends RelativeLayout {
    ...
    private void setupView(Context context) {
        ...
        mRootView = LayoutInflater.from(context).inflate(R.layout.hot_layout_view, this, true);
        mContentLayout = (RelativeLayout) findViewById(R.id.hot_content_view);
        mImageViewBelow = (ImageView) findViewById(R.id.hot_layout_below_bitmap);
        mImageViewAbove = (ImageView) findViewById(R.id.hot_layout_above_bitmap);
        mMatrix = new Matrix();
    ...
    public void foldWithoutAnimation() {
        if (!mIsFolded && !mIsAnimating) {
            ...
            mViewGroupDetail.setVisibility(GONE);
            if (HotLayout.this.getLayoutParams() != null) {
                HotLayout.this.getLayoutParams().height = mCoverHeight;
            }
            requestLayout();
        }
    }
    ...
    public void unfoldWithoutAnimation() {
        if (mIsFolded && !mIsAnimating) {
            ...
            clearImageView(mImageViewBelow);
            if (HotLayout.this.getLayoutParams() != null) {
                HotLayout.this.getLayoutParams().height = mCoverHeight * 2;
            }
            requestLayout();
            mIsFolded = false;
        }
        ...
        if (!mIsAnimating) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    HotLayout.this.getLayoutParams().height = (int) (initialHeight - initialHeight / 2 * animation.getAnimatedFraction());
                    HotLayout.this.requestLayout();
                }
            });
        ...
        if (!mIsAnimating) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    HotLayout.this.getLayoutParams().height = (int) (initialHeight + initialHeight * animation.getAnimatedFraction());
                    HotLayout.this.requestLayout();
